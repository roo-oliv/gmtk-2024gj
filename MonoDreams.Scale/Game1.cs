...
public class Game1 : Game
{
    ...
    protected override void Initialize()
    {
        ...
        _screenController.RegisterScreen(ScreenName.GameScreen, () => new GameScreen(this, GraphicsDevice, Content, _camera, _renderer, _runner, _spriteBatch));

        // _screenController.LoadScreen(ScreenName.MainMenu);
        _screenController.LoadScreen(ScreenName.GameScreen);
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        // GraphicsDevice.Clear(new Color(68, 76, 86));
