...
//         ImGui.Begin("Player", ImGuiWindowFlags.Modal);
//         
//         ImGui.Text($"Position: {player.Get<Position>().CurrentLocation}");
...
//         ImGui.End();
//         
//         var reactiveTiles = _world.GetEntities().With<ReactiveTile>().AsEnumerable();
//         ImGui.Begin("Reactive Tiles", ImGuiWindowFlags.Modal);
//         foreach (var tile in reactiveTiles)
//         {
//             ImGui.SetNextItemOpen(true);
//             if (ImGui.TreeNode($"Tile: {tile.ToString()}"))
//             {
//                 ImGui.Text($"Position: {tile.Get<Position>().CurrentLocation}");
//                 ImGui.Text($"Bounds: {tile.Get<Collidable>().Bounds}");
//                 ImGui.Text($"IsActivated: {tile.Get<ReactiveTile>().IsActivated}");
//                 ImGui.TreePop();
//             }
//         }
//         ImGui.End();
